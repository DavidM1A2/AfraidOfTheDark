...
public class AfraidOfTheDark
{
	 ...
	 */
	private final ScheduledExecutorService AOTD_EXECUTOR = Executors.newSingleThreadScheduledExecutor();

	/**
	 * Channel for sending and receiving packets
	 */
	private final PacketHandler PACKET_HANDLER = new PacketHandler("AOTD Packets");
	 ...
	 */
	public ScheduledExecutorService getAOTDExecutor()
	{
		return this.AOTD_EXECUTOR;
	}
}
