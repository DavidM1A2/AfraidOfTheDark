...
public abstract class AOTDSapling extends BlockBush implements IGrowable
{
	...
	public AOTDSapling()
	{
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(STAGE_PROP, 0));
	...
	{
		if (iBlockState.getValue(STAGE_PROP) == 0)
		{
	...
	{
		return this.getDefaultState().withProperty(STAGE_PROP, (meta & 8) >> 3);
	}
