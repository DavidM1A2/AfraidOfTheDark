 ...
 */
class AOTDBoltEntry(name: String, boltItem: Item, boltEntityFactory: (World, EntityPlayer) -> EntityBolt, preRequisite: Research?) : BoltEntry(boltItem, boltEntityFactory, preRequisite)
{
    init
    {
