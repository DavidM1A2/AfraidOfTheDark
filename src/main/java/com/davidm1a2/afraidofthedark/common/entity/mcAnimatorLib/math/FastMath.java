...
public class FastMath {
    ...
    /**
     * Returns the arc sine of a value. Special cases: If fValue is smaller than -1, then the result is -HALF_PI. If the argument is greater than 1,
     * then the result is HALF_PI.
     */
    ...
    /**
     * Returns the arc cosine of an angle given in radians. Special cases: If fValue is smaller than -1, then the result is PI. If the argument is
