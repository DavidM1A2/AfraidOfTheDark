...
public class Quaternion implements java.io.Serializable
{
    ...
    /**
     * Sets the data in this <code>Quaternion</code> object to be equal to the passed <code>Quaternion</code> object. The values are copied producing
     * a new object.
     *
    ...
    /**
     * Sets the value of this quaternion to the quaternion product of quaternions q1 and q2 (this = q1 * q2). Note that this is safe for aliasing
     * (e.g. this can be q1 or q2). This operation is used for adding the 2 orientations.
     */
    ...
    /**
     * Multiplies quaternion q1 by the inverse of quaternion q2 and places the value into this quaternion. The value of both argument quaternions is
