...
public class Matrix3d implements java.io.Serializable, Cloneable
{
    ...
    /**
     * Given a 3x3 array "matrix0", this function replaces it with the LU decomposition of a row-wise permutation of itself. The input parameters are
     * "matrix0" and "dimen". The array "matrix0" is also an output parameter. The vector "row_perm[3]" is an output parameter that contains the row
    ...
    /**
     * Solves a set of linear equations. The input parameters "matrix1", and "row_perm" come from luDecompostionD3x3 and do not change here. The
     * parameter "matrix2" is a set of column vectors assembled into a 3x3 matrix of floating-point values. The procedure takes each column of
    ...
    /**
     * Sets the values in this Matrix3d equal to the row-major array parameter (ie, the first three elements of the array will be copied into the
     * first row of this matrix, etc.).
     *
    ...
    /**
     * Multiplies this matrix by matrix m1, does an SVD normalization of the result, and places the result back into this matrix this =
     * SVDnorm(this*m1).
     *
    ...
    /**
     * Returns true if the Object t1 is of type Matrix3d and all of the data members of t1 are equal to the corresponding data members in this
     * Matrix3d.
     *
     ...
     * false. The L-infinite distance is equal to MAX[i=0,1,2 ; j=0,1,2 ; abs(this.m(i,j) - m1.m(i,j)]
     *
