...
public class AxisAngle4f implements java.io.Serializable, Cloneable {
    ...
    /**
     * Sets the value of this axis-angle to the rotational equivalent of the passed quaternion. If the specified quaternion has no rotational
    ...
    /**
     * Sets the value of this axis-angle to the rotational component of the passed matrix. If the specified matrix has no rotational component, the
    ...
    /**
     * Returns true if the Object o1 is of type AxisAngle4f and all of the data members of o1 are equal to the corresponding data members in this
     * AxisAngle4f.
     *
    ...
    /**
     * Returns true if the L-infinite distance between this axis-angle and axis-angle a1 is less than or equal to the epsilon parameter, otherwise
     * returns false. The L-infinite distance is equal to MAX[abs(x1-x2), abs(y1-y2), abs(z1-z2), abs(angle1-angle2)].
     *
