 ...
 */
class ChannelCharge internal constructor(name: String, fps: Float, totalFrames: Int, mode: ChannelMode) :
    ...
    override fun initializeAllFrames() {
        ...
        frame0.modelRenderersRotations["Pillar5"] = Quat4f(0.0f, -1.0f, 0.0f, -4.371139E-8f)
        ...
        frame24.modelRenderersRotations["Sphere1"] = Quat4f(0.70710677f, 0.0f, 0.0f, 0.70710677f)
        frame24.modelRenderersRotations["Pillar1"] = Quat4f(0.0f, -0.70710677f, 0.0f, 0.70710677f)
        frame24.modelRenderersRotations["Sphere2"] = Quat4f(0.70710677f, 0.0f, 0.0f, 0.70710677f)
        ...
        frame74.modelRenderersRotations["Sphere1"] = Quat4f(-0.70710677f, 0.0f, 0.0f, 0.7071068f)
        frame74.modelRenderersRotations["Pillar1"] = Quat4f(0.0f, 0.70710677f, 0.0f, 0.70710677f)
        frame74.modelRenderersRotations["Sphere2"] = Quat4f(-0.70710677f, 0.0f, 0.0f, 0.7071068f)
