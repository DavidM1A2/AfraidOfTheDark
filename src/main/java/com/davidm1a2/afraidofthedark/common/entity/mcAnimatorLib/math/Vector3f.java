 ...
 * <p>
 * Vector3f defines a Vector for a three float value tuple. Vector3f can represent any three dimensional value, such as a vertex, a normal, etc.
...
public final class Vector3f implements Cloneable, java.io.Serializable {
    ...
    /**
     * AddLocal adds a provided vector to this vector internally, and returns a handle to this vector for easy chaining of calls. If the provided
    ...
    /**
     * MultLocal multiplies a provided vector to this vector internally, and returns a handle to this vector for easy chaining of calls. If the
    ...
    /**
     * DivideLocal divides this vector by a scalar internally, and returns a handle to this vector for easy chaining of calls. Dividing by zero will
    ...
    /**
     * Subtract subtracts the values of a given vector from those of this vector creating a new vector object. If the provided vector is null, null is
     * returned.
     *
    ...
    /**
     * SubtractLocal subtracts a provided vector to this vector internally, and returns a handle to this vector for easy chaining of calls. If the
     * provided vector is null, null is returned.
     *
    ...
    /**
     * AngleBetween returns (in radians) the angle between two vectors. It is assumed that both this vector and the given vector are unit vectors
     * (iow, normalized).
     *
    ...
    /**
     * HashCode returns a unique code for this vector object based on it's values. If two vectors are logically equivalent, they will return the same
     * hash code value.
     *
