...
class ChannelBite internal constructor(name: String, fps: Float, totalFrames: Int, mode: ChannelMode) :
    ...
    override fun initializeAllFrames() {
        val frame0 = KeyFrame()
        frame0.modelRenderersRotations["Head"] = Quat4f(0.0784591f, 0.0f, 0.0f, 0.9969173f)
        frame0.modelRenderersTranslations["Head"] = Vector3f(0.0f, 3.0f, 10.0f)
        keyFrames[0] = frame0
        val frame20 = KeyFrame()
        frame20.modelRenderersRotations["SnoutLower"] = Quat4f(0.043619387f, 0.0f, 0.0f, 0.99904823f)
        frame20.modelRenderersRotations["Head"] = Quat4f(0.077267125f, -0.01362428f, -0.17311287f, 0.9817719f)
        ...
        frame39.modelRenderersRotations["SnoutLower"] = Quat4f(0.17364818f, 0.0f, 0.0f, 0.9848077f)
        frame39.modelRenderersRotations["Head"] = Quat4f(0.0784591f, 0.0f, 0.0f, 0.9969173f)
        ...
        frame14.modelRenderersRotations["SnoutLower"] = Quat4f(0.42261827f, 0.0f, 0.0f, 0.90630776f)
