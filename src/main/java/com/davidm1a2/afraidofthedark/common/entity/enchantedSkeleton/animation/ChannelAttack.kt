 ...
 */
class ChannelAttack internal constructor(name: String, fps: Float, totalFrames: Int, mode: Byte) : Channel(name, fps, totalFrames, mode)
{
    /**
    ...
    override fun initializeAllFrames()
    {
        ...
        frame19.modelRenderersRotations["rightarm"] = Quaternion(-0.9542403f, 0.0f, 0.0f, 0.2990408f)
        frame19.modelRenderersRotations["leftarm"] = Quaternion(-0.9378889f, 0.0f, 0.0f, 0.3469357f)
