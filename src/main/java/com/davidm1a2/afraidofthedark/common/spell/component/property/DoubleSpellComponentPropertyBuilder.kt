 ...
 */
class DoubleSpellComponentPropertyBuilder : BoundedSpellComponentPropertyBuilder<Double, DoubleSpellComponentPropertyBuilder>()
{
    /**
    ...
    {
        return DoubleSpellComponentProperty(name!!, description!!, setter!!, getter!!, defaultValue!!, minValue, maxValue)
    }
}