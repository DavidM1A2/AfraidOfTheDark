 ...
 */
class FloatSpellComponentPropertyBuilder : BoundedSpellComponentPropertyBuilder<Float, FloatSpellComponentPropertyBuilder>()
{
    /**
    ...
    {
        return FloatSpellComponentProperty(name!!, description!!, setter!!, getter!!, defaultValue!!, minValue, maxValue)
    }
}