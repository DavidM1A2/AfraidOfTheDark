...
class OverworldHeightmap @JvmOverloads constructor(identifier: String = IDENTIFIER) : WorldSavedData(identifier), IHeightmap {
    ...
    companion object {
         ...
         */
        fun get(world: IWorld): IHeightmap {
            ...
            var heightmap = storage.func_212426_a(world.dimension.type, { OverworldHeightmap() }, IDENTIFIER)
            ...
            if (heightmap == null) {
                ...
                storage.func_212424_a(world.dimension.type, IDENTIFIER, heightmap)
                heightmap.markDirty()
            }
            // Return the data
            return heightmap
