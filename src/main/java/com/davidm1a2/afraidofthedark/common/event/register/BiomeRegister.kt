...
class BiomeRegister
{
    ...
    fun registerBiomes(event: RegistryEvent.Register<Biome?>)
    {
        ...
        BiomeManager.addBiome(BiomeManager.BiomeType.COOL, BiomeEntry(ModBiomes.ERIE_FOREST, configurationHandler.erieBiomeFrequency))
        BiomeManager.addBiome(BiomeManager.BiomeType.WARM, BiomeEntry(ModBiomes.ERIE_FOREST, configurationHandler.erieBiomeFrequency))
