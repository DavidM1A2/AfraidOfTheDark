...
class ConfigurationHandler(configurationFile: File) {
    ...
    private fun refreshConfiguration() {
        ...
        configuration.addCustomCategoryComment(
            ...
            "Here you can set how frequently certain dungeons appear."
        )
        configuration.addCustomCategoryComment(
            CATEGORY_WORLD_GENERATION,
            "Here you can set world generation properties."
        )
        ...
        desertOasisMultiplier = configuration.getFloat(
            "Desert Oasis Multiplier",
            CATEGORY_DUNGEON_FREQUENCY,
            1.0f,
            0.0f,
            100.0f,
