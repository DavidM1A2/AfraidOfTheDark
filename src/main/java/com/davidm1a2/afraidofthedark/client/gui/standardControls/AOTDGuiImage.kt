 ...
 * @property maxTextureWidth The maximum texture width. If we don't have a texture width use this control's width as the image's width
        ...
        AOTDGuiContainer(x, y, width, height)
{
    ...
    val maxTextureWidth: Int
        get() = if (textureWidth == -1)
        {
            this.width
        }
        else
    ...
    val maxTextureHeight: Int
        get() = if (textureHeight == -1)
        {
            this.height
        }
        else
