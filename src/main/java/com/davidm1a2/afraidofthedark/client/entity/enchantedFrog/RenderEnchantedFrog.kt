 ...
 */
class RenderEnchantedFrog(renderManager: RenderManager) :
    RenderLiving<EntityEnchantedFrog>(renderManager, ENCHANTED_FROG_MODEL, MODEL_SHADOW_SIZE) {
    /**
     ...
     */
    override fun preRenderCallback(entityLiving: EntityEnchantedFrog, partialTickTime: Float) {
     ...
     */
    override fun getEntityTexture(entity: EntityEnchantedFrog): ResourceLocation {
    ...
    companion object {
        ...
        // The frog model
        private val ENCHANTED_FROG_MODEL = ModelEnchantedFrog()
