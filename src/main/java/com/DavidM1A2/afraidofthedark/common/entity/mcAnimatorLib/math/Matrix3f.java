...
public final class Matrix3f implements Cloneable, java.io.Serializable
{
	 ...
	 *
	 * @param data
	 *            The array to return the data into. This array can be 9 or 16 floats in size. Only the upper 3x3 are assigned to in the case of a 16
	 *            element array.
	 * @param rowMajor
	 *            True for row major storage in the array (translation in elements 3, 7, 11 for a 4x4), false for column major (translation in
