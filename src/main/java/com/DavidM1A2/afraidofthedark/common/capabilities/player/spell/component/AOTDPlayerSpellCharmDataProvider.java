 ...
 */
public class AOTDPlayerSpellCharmDataProvider implements ICapabilitySerializable<NBTBase>
{
    // The instance of the player spell freeze data capability
    private IAOTDPlayerSpellCharmData instance = ModCapabilities.PLAYER_SPELL_CHARM_DATA.getDefaultInstance();
    ...
    {
        return capability == ModCapabilities.PLAYER_SPELL_CHARM_DATA ? ModCapabilities.PLAYER_SPELL_CHARM_DATA.cast(this.instance) : null;
    }
    ...
    {
        return ModCapabilities.PLAYER_SPELL_CHARM_DATA.getStorage().writeNBT(ModCapabilities.PLAYER_SPELL_CHARM_DATA, this.instance, null);
    }
    ...
    {
        ModCapabilities.PLAYER_SPELL_CHARM_DATA.getStorage().readNBT(ModCapabilities.PLAYER_SPELL_CHARM_DATA, this.instance, null, nbt);
    }
}
