 ...
 */
class DoubleSpellComponentProperty extends SpellComponentProperty
{
    /**
     ...
     */
    DoubleSpellComponentProperty(String name, String description, Consumer<Double> setter, Supplier<Double> getter, Double defaultValue, Double minValue, Double maxValue)
    {
        super(name,
                description,
                newValue ->
