 ...
 *
 * @param <T> The type of entity we are rendering, will be enchanted skeleton ONLY
 */
public class RenderEnchantedSkeleton<T extends EntityEnchantedSkeleton> extends RenderLiving<T>
{
	 ...
	 */
	@Override
	public void doRender(T entity, double posX, double posY, double posZ, float entityYaw, float partialTicks)
	{
