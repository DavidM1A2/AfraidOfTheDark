...
import com.DavidM1A2.afraidofthedark.common.entity.mcAnimatorLib.Utils;
...
public class MCAModelRenderer extends ModelRenderer
{
	...
	public ModelRenderer addBox(String par1Str, float par2, float par3, float par4, int par5, int par6, int par7)
	{
		...
		this.cubeList.add((new MCAModelBox(this, this.DDStextureOffsetX, this.DDStextureOffsetY, par2, par3, par4, par5,
				par6, par7, 0.0F)).setBoxName(par1Str));
		return this;
	}
	...
	{
		this.cubeList.add(new MCAModelBox(this, this.DDStextureOffsetX, this.DDStextureOffsetY, par1, par2, par3, par4,
				par5, par6, 0.0F));
		return this;
	}
