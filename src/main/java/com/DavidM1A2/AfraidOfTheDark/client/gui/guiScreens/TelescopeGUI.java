...
public class TelescopeGUI extends AOTDGuiClickAndDragable
{
	...
	public TelescopeGUI()
	{
		...
		AOTDGuiImage telescopeFrame = new AOTDGuiImage(0, 0, FRAME_WIDTH, FRAME_HEIGHT, "afraidofthedark:textures/gui/telescope_gui.png");
		telescopeMeteors = new AOTDGuiPanel(0, 0, FRAME_WIDTH, FRAME_HEIGHT, false);
		telescopeImage = new AOTDGuiImage(0, 0, FRAME_WIDTH, FRAME_HEIGHT, 2160, 3840, "afraidofthedark:textures/gui/telescope_background.png");
