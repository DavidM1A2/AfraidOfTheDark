...
public class TrueTypeFont
{
	...
	private void drawQuad(float drawX, float drawY, float drawX2, float drawY2, float srcX, float srcY, float srcX2, float srcY2)
	{
		...
		//		Gui.drawScaledCustomSizeModalRect((int) drawX, (int) drawY, srcX, srcY, (int) -SrcWidth, (int) -SrcHeight, (int) DrawWidth, (int) DrawHeight, textureWidth, textureHeight);
		//
		// u = srcX
		// v = srcY
		// uWidth = -SrcWidth
		// vHeight = -SrcHeight
		// 
		//      worldrenderer.addVertexWithUV(x,            y,           0.0D, (u / tileWidth), (v / tileHeight));
		//      worldrenderer.addVertexWithUV(x,           (y + height), 0.0D, (u / tileWidth), ((v + vHeight) / tileHeight));
		//      worldrenderer.addVertexWithUV((x + width),  y,           0.0D, ((u + uWidth) / tileWidth), (v / tileHeight));
		//      worldrenderer.addVertexWithUV((x + width), (y + height), 0.0D, ((u + uWidth) / tileWidth), ((v + vHeight) / tileHeight));

		worldRenderer.addVertexWithUV(drawX, drawY, 0, TextureSrcX, TextureSrcY);
		//GL11.glTexCoord2f(TextureSrcX, TextureSrcY);
		//GL11.glVertex2f(drawX, drawY);

		worldRenderer.addVertexWithUV(drawX, drawY + DrawHeight, 0, TextureSrcX, TextureSrcY + RenderHeight);
		//GL11.glTexCoord2f(TextureSrcX, TextureSrcY + RenderHeight);
		//GL11.glVertex2f(drawX, drawY + DrawHeight);

		worldRenderer.addVertexWithUV(drawX + DrawWidth, drawY + DrawHeight, 0, TextureSrcX + RenderWidth, TextureSrcY + RenderHeight);
		//GL11.glTexCoord2f(TextureSrcX + RenderWidth, TextureSrcY + RenderHeight);
		//GL11.glVertex2f(drawX + DrawWidth, drawY + DrawHeight);

		worldRenderer.addVertexWithUV(drawX + DrawWidth, drawY, 0, TextureSrcX + RenderWidth, TextureSrcY);
	...
	public void drawString(float x, float y, String whatchars, int startIndex, int endIndex, float scaleX, float scaleY, int format, float... rgba)
	{
		...
		if (rgba.length == 4)
			worldRenderer.setColorRGBA_F(rgba[0], rgba[1], rgba[2], rgba[3]);
