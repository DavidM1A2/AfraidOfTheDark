...
public class TileEntityVoidChestRenderer extends TileEntitySpecialRenderer<TileEntityVoidChest>
{
	...
	@Override
	public void render(TileEntityVoidChest tileEntity, double x, double y, double z, float lidPosition, int damage, float alpha)
	{
		super.render(tileEntity, x, y, z, lidPosition, damage, alpha);
