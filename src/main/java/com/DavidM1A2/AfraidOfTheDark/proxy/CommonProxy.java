...
public abstract class CommonProxy implements IProxy
{
	public void registerChannel()
	{
		...
		AfraidOfTheDark.channelNew.registerMessage(UpdateAOTDStatus.HandlerServer.class, UpdateAOTDStatus.class,
				Refrence.PACKET_ID_HAS_STARTED_AOTD_UPDATE_SERVER, Side.SERVER);
		AfraidOfTheDark.channelNew.registerMessage(UpdateAOTDStatus.HandlerClient.class, UpdateAOTDStatus.class,
				Refrence.PACKET_ID_HAS_STARTED_AOTD_UPDATE_CLIENT, Side.CLIENT);
