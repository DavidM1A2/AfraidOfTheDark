...
public class ItemCrossbow extends AOTDItem
{
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
	{
		...
		tooltip.add("Left click to fire, hold right click to load.");
		tooltip.add("Bow will fire: " + AOTDCrossbowBoltTypes.getTypeFromID(NBTHelper.getInt(stack, "mode")) + " bolts.");
	}
