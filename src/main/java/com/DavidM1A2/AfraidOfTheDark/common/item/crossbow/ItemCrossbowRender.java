...
// @Override
// public boolean handleRenderType(final ItemStack item, final ItemRenderType
/// type)
// {
// switch (type)
// {
...
// // ?
// @Override
// public boolean shouldUseRenderHelper(final ItemRenderType type, final
/// ItemStack item, final ItemRendererHelper helper)
// {
// return false;
// }
//
...
// @Override
// public void renderItem(final ItemRenderType type, final ItemStack itemStack,
/// final Object... data)
// {
// switch (type)
// {
...
/// ResourceLocation("afraidofthedark:textures/models/crossbowTexture.png"));
//
...
// }
//
// // Call the render function and pop the matrix off of the stack enabling the
/// renderer
// this.crossbowModel.render((Entity) data[1], 0.0F, 0.0F, 0.0F, 0.0F, 0.0F,
/// 0.0625F);
//
// GL11.glPopMatrix();
// }
...
// {
//
// // First person works the same as third except this time we have different
/// dimensions for scale, yaw, pitch, roll, and translation
// GL11.glPushMatrix();
//
// Minecraft.getMinecraft().renderEngine.bindTexture(new
/// ResourceLocation("afraidofthedark:textures/models/crossbowTexture.png"));
