...
public interface IDeliveryMethod {
	...
	/**
	 * 
	 * @param previous The previous entity spell to this one
	 * @param spellStageIndex The current index into the spell's array of stages
	...
	/**
	 * 
	 * @param callback The spell that's calling the projectile to be made. This means this 
	 * projectile is the first delivery method
	 * @return An entity spell ready to be instantiated into the mc world
	 */
	public abstract EntitySpell createSpellEntity(Spell callback);
	/**
	 * 
	 * @param renderManager The render manager given to us in proxy
