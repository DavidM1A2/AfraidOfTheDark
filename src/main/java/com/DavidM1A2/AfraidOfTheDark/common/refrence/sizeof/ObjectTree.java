...
/**
 * Dumps retained and shallow memory taken by an object and its reference hierarchy. This could be improved in a number of ways but works for
 * debugging and "live" object monitoring. For static heap analyses a real performance monitor like YourKit is much better (and accurate?).
 * 
