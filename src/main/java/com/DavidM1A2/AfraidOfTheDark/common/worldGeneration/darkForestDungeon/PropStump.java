...
public class PropStump
{
	public PropStump(World world, Random rand, int x, int y, int z) 
	{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		this.setBlock(world, i + 0, j + 0, k + 1, Blocks.log, 1);
		this.setBlock(world, i + 1, j + 0, k + 0, Blocks.log, 1);
		this.setBlock(world, i + 1, j + 0, k + 1, Blocks.dirt, 0);
		this.setBlock(world, i + 1, j + 0, k + 2, Blocks.log, 1);
		this.setBlock(world, i + 2, j + 0, k + 1, Blocks.log, 1);
