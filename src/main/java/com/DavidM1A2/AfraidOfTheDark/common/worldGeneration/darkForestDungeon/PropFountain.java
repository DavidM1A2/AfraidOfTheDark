...
public class PropFountain
{
	...
	public void setBlock(World world, int x, int y, int z, Block block, int metadata)
	{
		...
		//world.markAndNotifyBlock(new BlockPos(x, y, z), world.getChunkFromBlockCoords(new BlockPos(x, y, z)), Blocks.water.getDefaultState(), Blocks.water, 2);
	}
	...
	public boolean generate(World world, Random rand, int i, int j, int k)
	{
		...
		this.setBlock(world, i + 3, j + 3, k + 2, Blocks.flowing_water, 0);
