...
public class GnomishCityLoot implements IChestGenerator
{
	...
	public List<WeightedRandomChestContent> getPossibleItems(Random random)
	{
		...
		toReturn.add(new WeightedRandomChestContent(Item.getItemFromBlock(ModBlocks.gnomishMetalPlate), 0, 3, 25, 25));
		toReturn.add(new WeightedRandomChestContent(Item.getItemFromBlock(ModBlocks.gnomishMetalStrut), 0, 3, 25, 25));
