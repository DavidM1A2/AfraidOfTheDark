...
public class RenderSplinterDrone extends RenderLiving {
	...
	public static final ResourceLocation SplinterDrone_texture = new ResourceLocation("yourAssetsFolder", "textures/models/SplinterDrone.png");
