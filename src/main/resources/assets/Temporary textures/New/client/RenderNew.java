...
public class RenderNew extends RenderLiving {

	public static final ResourceLocation New_texture = new ResourceLocation("yourAssetsFolder", "textures/models/New.png");
	public static ModelNew modelNew = new ModelNew();	
	...
	public void doRender(Entity _entity, double posX, double posY, double posZ, float var8, float var9) {
		EntityNew entity = (EntityNew) _entity;
