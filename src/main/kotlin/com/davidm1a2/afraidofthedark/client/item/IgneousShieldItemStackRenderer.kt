package com.davidm1a2.afraidofthedark.client.item
...
class IgneousShieldItemStackRenderer : ItemStackTileEntityRenderer() {
    override fun renderByItem(
        ...
        SHIELD_MODEL.handle().render(matrixStack, iVertexBuilder, packedLight, packedOverlay, 1.0f, 1.0f, 1.0f, 1.0f)
        SHIELD_MODEL.plate().render(matrixStack, iVertexBuilder, packedLight, packedOverlay, 1.0f, 1.0f, 1.0f, 1.0f)

        matrixStack.popPose()
    }

    companion object {
        private val SHIELD_MODEL = ShieldModel()
    }
}