...
open class RadialPane : RatioPane(1, 1) {
    ...
    override fun calcChildrenBounds() {// Calculate padding
        ...
        for (child in this.getChildren()) {
            ...
            // Set position
            child.x = (this.x + this.guiOffsetX + calcPadding.left + gravityXOffset + sin(tVal)*rVal).roundToInt()
            child.y = (this.y + this.guiOffsetY + calcPadding.top + gravityYOffset + cos(tVal)*rVal).roundToInt()
