 ...
 */
class AOTDGuiLabel(width: Int, height: Int, val font: TrueTypeFont, gravity: AOTDGuiGravity = AOTDGuiGravity.CENTER) : AOTDGuiContainer(width, height, gravity = gravity) {
