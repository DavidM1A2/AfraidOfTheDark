...
class VoidChestConfig(val frequency: Double) : IFeatureConfig {
    ...
    companion object {
        fun <T> deserialize(dynamic: Dynamic<T>): VoidChestConfig {
            return VoidChestConfig(dynamic.get("frequency").asDouble(0.0))
        }
    }
}