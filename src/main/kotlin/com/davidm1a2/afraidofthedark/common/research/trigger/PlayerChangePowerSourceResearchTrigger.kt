...
class PlayerChangePowerSourceResearchTrigger :
    ...
    override fun getAffectedPlayer(event: PlayerChangePowerSourceEvent, config: PlayerChangePowerSourceResearchTriggerConfig): PlayerEntity? {
        return event.player
    }

    override fun shouldUnlock(player: PlayerEntity, event: PlayerChangePowerSourceEvent, config: PlayerChangePowerSourceResearchTriggerConfig): Boolean {
