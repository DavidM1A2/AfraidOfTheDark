...
object ModItems {
    ...
    val ASTRAL_SILVER_HELMET = AstralSilverArmorItem("astral_silver_helmet", EquipmentSlot.HEAD)
    val ASTRAL_SILVER_CHESTPLATE = AstralSilverArmorItem("astral_silver_chestplate", EquipmentSlot.CHEST)
    val ASTRAL_SILVER_LEGGINGS = AstralSilverArmorItem("astral_silver_leggings", EquipmentSlot.LEGS)
    val ASTRAL_SILVER_BOOTS = AstralSilverArmorItem("astral_silver_boots", EquipmentSlot.FEET)
    ...
    val IGNEOUS_HELMET = IgneousArmorItem("igneous_helmet", EquipmentSlot.HEAD)
    val IGNEOUS_CHESTPLATE = IgneousArmorItem("igneous_chestplate", EquipmentSlot.CHEST)
    val IGNEOUS_LEGGINGS = IgneousArmorItem("igneous_leggings", EquipmentSlot.LEGS)
    val IGNEOUS_BOOTS = IgneousArmorItem("igneous_boots", EquipmentSlot.FEET)
    ...
    val STAR_METAL_HELMET = StarMetalArmorItem("star_metal_helmet", EquipmentSlot.HEAD)
    val STAR_METAL_CHESTPLATE = StarMetalArmorItem("star_metal_chestplate", EquipmentSlot.CHEST)
    val STAR_METAL_LEGGINGS = StarMetalArmorItem("star_metal_leggings", EquipmentSlot.LEGS)
    val STAR_METAL_BOOTS = StarMetalArmorItem("star_metal_boots", EquipmentSlot.FEET)
    ...
    val ELDRITCH_METAL_HELMET = EldritchMetalArmorItem("eldritch_metal_helmet", EquipmentSlot.HEAD)
    val ELDRITCH_METAL_CHESTPLATE = EldritchMetalArmorItem("eldritch_metal_chestplate", EquipmentSlot.CHEST)
    val ELDRITCH_METAL_LEGGINGS = EldritchMetalArmorItem("eldritch_metal_leggings", EquipmentSlot.LEGS)
    val ELDRITCH_METAL_BOOTS = EldritchMetalArmorItem("eldritch_metal_boots", EquipmentSlot.FEET)
    ...
    val AMORPHOUS_METAL_HELMET = AmorphousMetalArmorItem("amorphous_metal_helmet", EquipmentSlot.HEAD)
    val AMORPHOUS_METAL_CHESTPLATE = AmorphousMetalArmorItem("amorphous_metal_chestplate", EquipmentSlot.CHEST)
    val AMORPHOUS_METAL_LEGGINGS = AmorphousMetalArmorItem("amorphous_metal_leggings", EquipmentSlot.LEGS)
    val AMORPHOUS_METAL_BOOTS = AmorphousMetalArmorItem("amorphous_metal_boots", EquipmentSlot.FEET)
    ...
    val VOID_HELMET = VoidArmorItem("void_helmet", EquipmentSlot.HEAD)
    val VOID_CHESTPLATE = VoidArmorItem("void_chestplate", EquipmentSlot.CHEST)
    val VOID_LEGGINGS = VoidArmorItem("void_leggings", EquipmentSlot.LEGS)
    val VOID_BOOTS = VoidArmorItem("void_boots", EquipmentSlot.FEET)
