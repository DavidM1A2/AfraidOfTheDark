...
object ModLootTables {
    ...
    val NIGHTMARE_ISLAND = LootTable(
        ...
        mapOf(
            ...
            Items.EMERALD to ResourceLocation(Constants.MOD_ID, "chests/nightmare/vitae1_part1"),
            Items.IRON_INGOT to ResourceLocation(Constants.MOD_ID, "chests/nightmare/vitae1_part2"),
            Items.GOLD_INGOT to ResourceLocation(Constants.MOD_ID, "chests/nightmare/vitae1_part3"),
            Items.NETHER_BRICK to ResourceLocation(Constants.MOD_ID, "chests/nightmare/vitae1_part4"),
            Items.COAL to ResourceLocation(Constants.MOD_ID, "chests/nightmare/vitae1_part5"),
