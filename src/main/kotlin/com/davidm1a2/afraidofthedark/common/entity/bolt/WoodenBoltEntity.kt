 ...
 */
class WoodenBoltEntity(entityType: EntityType<out WoodenBoltEntity>, world: World) : BoltEntity(entityType, world) {
    ...
    constructor(world: World) : this(ModEntities.WOODEN_BOLT, world)
}