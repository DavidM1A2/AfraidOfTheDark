...
class WoodenBoltEntity : BoltEntity {
     ...
     */
    constructor(entityType: EntityType<out WoodenBoltEntity>, world: World) : super(entityType, world)
     ...
     */
    constructor(entityType: EntityType<out WoodenBoltEntity>, x: Double, y: Double, z: Double, world: World) : super(entityType, x, y, z, world)
     ...
     */
    constructor(entityType: EntityType<out WoodenBoltEntity>, thrower: LivingEntity, world: World) : super(entityType, thrower, world)
}