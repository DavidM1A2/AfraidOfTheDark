...
class EnariaEntity(entityType: EntityType<out EnariaEntity>, world: Level) : Mob(entityType, world), IMCAnimatedModel {
    ...
    private val bossInfo = ServerBossEvent(
    ...
    init {
        ...
        this.customName = TextComponent("Enaria")
    ...
    override fun registerGoals() {
        ...
        goalSelector.addGoal(2, LookAtPlayerGoal(this, Player::class.java, 100.0f))
    }
    ...
    override fun baseTick() {
        ...
        if (level.isClientSide) {
            ...
            bossInfo.progress = this.health / this.maxHealth
            ...
            if (source is EntityDamageSource) {
                ...
                if (damageSource is Player) {
                    ...
                    if (!damageSource.getResearch().canResearch(ModResearches.ARCH_SORCERESS) && !damageSource.getResearch().isResearched(ModResearches.ARCH_SORCERESS)) {
                        damageSource.sendMessage(TranslatableComponent("message.afraidofthedark.enaria.dont_understand"))
    ...
    override fun readAdditionalSaveData(compound: CompoundTag) {
        ...
        this.spawnerTilePos = NbtUtils.readBlockPos(compound.getCompound("spawner_tile_pos"))
        if (!level.isClientSide) {
    ...
    override fun addAdditionalSaveData(compound: CompoundTag) {
        ...
        compound.put("spawner_tile_pos", NbtUtils.writeBlockPos(this.spawnerTilePos))
        if (!level.isClientSide) {
