...
class BiteChannel internal constructor(name: String, fps: Float, totalFrames: Int, mode: ChannelMode) :
    ...
    override fun initializeAllFrames() {
        ...
        frame20.modelRotations["SnoutLower"] = Quaternion(0.043619387f, 0.0f, 0.0f, 0.99904823f)
        frame20.modelRotations["Head"] = Quaternion(0.077267125f, -0.01362428f, -0.17311287f, 0.9817719f)
        ...
        frame39.modelRotations["SnoutLower"] = Quaternion(0.17364818f, 0.0f, 0.0f, 0.9848077f)
        frame39.modelRotations["Head"] = Quaternion(0.0784591f, 0.0f, 0.0f, 0.9969173f)
        ...
        frame14.modelRotations["SnoutLower"] = Quaternion(0.42261827f, 0.0f, 0.0f, 0.90630776f)
