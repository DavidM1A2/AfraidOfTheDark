...
class FlyChannel internal constructor(name: String, fps: Float, totalFrames: Int, mode: ChannelMode) :
    ...
    init {
        ...
        frame0.modelTranslations["phoenixBreast"] = Vector3f(-5.0f, 5.0f, 0.0f)
        ...
        frame5.modelTranslations["phoenixBreast"] = Vector3f(-5.0f, 4.0f, 0.0f)
        ...
        frame10.modelTranslations["phoenixBreast"] = Vector3f(-5.0f, 5.5f, 0.0f)
        ...
        frame15.modelTranslations["phoenixBreast"] = Vector3f(-5.0f, 5.0f, 0.0f)
