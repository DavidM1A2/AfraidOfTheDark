 ...
 */
class IronBoltEntity(entityType: EntityType<out IronBoltEntity>, world: Level) : BoltEntity(entityType, world) {
    ...
    constructor(world: Level) : this(ModEntities.IRON_BOLT, world)
}