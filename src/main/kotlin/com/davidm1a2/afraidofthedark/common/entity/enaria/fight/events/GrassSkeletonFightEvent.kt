...
class GrassSkeletonFightEvent(fight: EnariaFight) : EnariaFightEvent(fight, EnariaFightEvents.GrassSkeleton) {
    ...
    override fun tick() {
        ...
        if (ticksUntilEnd % 5 == 0 && numberGrowSpellsLeft > 0) {
            ...
            val hitPos = Vec3.atCenterOf(relativeToAbsolutePosition(Random.nextInt(-30, 30), -1, Random.nextInt(-3, 79)))
            fight.enaria.lookAt(EntityAnchorArgument.Anchor.EYES, hitPos)
