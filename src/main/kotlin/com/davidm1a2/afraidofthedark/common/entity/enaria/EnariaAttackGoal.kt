 ...
 */
class EnariaAttackGoal(private val enaria: EnariaEntity) : Goal() {
    ...
    override fun tick() {
        // Look at the target
        enaria.lookController.setLookPositionWithEntity(target!!, 30.0f, 30.0f)
        ...
        if (ticksUntilNextAttack <= 0) {
            ...
            enaria.enariaAttackHelper.performRandomSpell()
            ...
            if (!enaria.isPotionActive(Effects.INVISIBILITY)) {
                // Perform basic attack
                enaria.enariaAttackHelper.performBasicAttack()
