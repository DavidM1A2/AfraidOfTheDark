 ...
 */
class StructureMissCounterStorage : Capability.IStorage<IStructureMissCounter> {
    private val structures = ForgeRegistries.FEATURES.filterIsInstance<AOTDStructure<*>>()

    override fun writeNBT(capability: Capability<IStructureMissCounter>, instance: IStructureMissCounter, side: Direction?): INBT {
    ...
    companion object {
        private val LOG = LogFactory.getLog(StructureMissCounterStorage::class.java)
