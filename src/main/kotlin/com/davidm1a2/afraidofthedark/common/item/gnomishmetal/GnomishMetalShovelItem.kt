...
class GnomishMetalShovelItem : AOTDResearchRequiredShovelItem("gnomish_metal_shovel", ModToolMaterials.GNOMISH_METAL, 0f, -3f, ModResearches.EXCAVATION_ENGINEERING, Properties()) {
