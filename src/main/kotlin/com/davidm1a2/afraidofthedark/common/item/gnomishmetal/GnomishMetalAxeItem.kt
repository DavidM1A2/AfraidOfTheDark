...
class GnomishMetalAxeItem : AOTDResearchRequiredAxeItem("gnomish_metal_axe", ModToolMaterials.GNOMISH_METAL, 0.0f, -3.0f, ModResearches.EXCAVATION_ENGINEERING, Properties()) {
