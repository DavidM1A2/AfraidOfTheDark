...
class EldritchMetalSwordItem : AOTDResearchRequiredSwordItem("eldritch_metal_sword", ModToolMaterials.ELDRITCH_METAL, 3, -2.4f, ModResearches.AN_UNSETTLING_MATERIAL, Properties()) {
